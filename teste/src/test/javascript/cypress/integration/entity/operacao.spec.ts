...
describe('Operacao e2e test', () => {
  ...
  describe('new Operacao page', () => {
    ...
    it('should create an instance of Operacao', () => {
      ...
      cy.get(`[data-cy="inicio"]`).type('2022-04-07T10:01').should('have.value', '2022-04-07T10:01');

      cy.get(`[data-cy="fim"]`).type('2022-04-07T11:22').should('have.value', '2022-04-07T11:22');
      ...
      cy.get(`[data-cy="createdDate"]`).type('2022-04-07T19:39').should('have.value', '2022-04-07T19:39');

      cy.get(`[data-cy="lastModifiedBy"]`).type('e-commerce program').should('have.value', 'e-commerce program');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2022-04-07T19:45').should('have.value', '2022-04-07T19:45');

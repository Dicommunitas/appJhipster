...
describe('Operacao e2e test', () => {
  ...
  describe('new Operacao page', () => {
    ...
    it('should create an instance of Operacao', () => {
      ...
      cy.get(`[data-cy="inicio"]`).type('2022-04-26T00:19').should('have.value', '2022-04-26T00:19');

      cy.get(`[data-cy="fim"]`).type('2022-04-26T01:40').should('have.value', '2022-04-26T01:40');
      ...
      cy.get(`[data-cy="createdDate"]`).type('2022-04-26T09:57').should('have.value', '2022-04-26T09:57');

      cy.get(`[data-cy="lastModifiedBy"]`).type('e-commerce program').should('have.value', 'e-commerce program');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2022-04-26T10:03').should('have.value', '2022-04-26T10:03');

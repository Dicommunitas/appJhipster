...
describe('Relatorio e2e test', () => {
  ...
  const relatorioSample = { dataHora: '2022-04-07T07:18:57.678Z', relato: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=' };
  ...
  describe('new Relatorio page', () => {
    ...
    it.skip('should create an instance of Relatorio', () => {
      cy.get(`[data-cy="dataHora"]`).type('2022-04-07T09:14').should('have.value', '2022-04-07T09:14');

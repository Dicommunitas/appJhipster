...
describe('Relatorio e2e test', () => {
  ...
  const relatorioSample = { dataHora: '2022-04-12T09:40:55.678Z', relato: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=' };
  ...
  describe('new Relatorio page', () => {
    ...
    it.skip('should create an instance of Relatorio', () => {
      cy.get(`[data-cy="dataHora"]`).type('2022-04-12T11:36').should('have.value', '2022-04-12T11:36');

...
describe('Amostra e2e test', () => {
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/operacaos',
      body: {"descricao":"Orchestrator","volumePeso":32077,"inicio":"2022-04-06T20:20:26.755Z","fim":"2022-04-07T09:15:49.791Z","quantidadeAmostras":73104,"observacao":"payment TCP","createdBy":"Forward Computador envisioneer","createdDate":"2022-04-07T02:54:03.240Z","lastModifiedBy":"applications","lastModifiedDate":"2022-04-07T05:00:38.708Z"},
    }).then(({ body }) => {
      operacao = body;
    });
    // create an instance at the required relationship entity:
  ...
  describe('new Amostra page', () => {
    ...
    it.skip('should create an instance of Amostra', () => {
      cy.get(`[data-cy="dataHoraColeta"]`).type('2022-04-07T07:47').should('have.value', '2022-04-07T07:47');
      ...
      cy.get(`[data-cy="recebimentoNoLaboratorio"]`).type('2022-04-07T09:47').should('have.value', '2022-04-07T09:47');

      cy.get(`[data-cy="createdBy"]`).type('Associate').should('have.value', 'Associate');

      cy.get(`[data-cy="createdDate"]`).type('2022-04-07T16:42').should('have.value', '2022-04-07T16:42');

      cy.get(`[data-cy="lastModifiedBy"]`).type('integrate schemas').should('have.value', 'integrate schemas');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2022-04-07T07:26').should('have.value', '2022-04-07T07:26');

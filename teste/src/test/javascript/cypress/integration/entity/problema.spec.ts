...
describe('Problema e2e test', () => {
  ...
  describe('new Problema page', () => {
    ...
    it.skip('should create an instance of Problema', () => {
      cy.get(`[data-cy="dataVerificacao"]`).type('2022-04-07').should('have.value', '2022-04-07');
      ...
      cy.get(`[data-cy="dataFinalizacao"]`).type('2022-04-07').should('have.value', '2022-04-07');

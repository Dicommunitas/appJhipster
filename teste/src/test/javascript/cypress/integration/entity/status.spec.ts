...
describe('Status e2e test', () => {
  ...
  describe('new Status page', () => {
    ...
    it.skip('should create an instance of Status', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2022-04-13T23:10').should('have.value', '2022-04-13T23:10');

      cy.get(`[data-cy="lastModifiedBy"]`).type('Solutions').should('have.value', 'Solutions');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2022-04-13T20:28').should('have.value', '2022-04-13T20:28');

package com.operacional.myapp2.web.rest;

import com.operacional.myapp2.domain.C;
import com.operacional.myapp2.repository.CRepository;
import com.operacional.myapp2.service.CService;
import com.operacional.myapp2.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.operacional.myapp2.domain.C}.
 */
@RestController
@RequestMapping("/api")

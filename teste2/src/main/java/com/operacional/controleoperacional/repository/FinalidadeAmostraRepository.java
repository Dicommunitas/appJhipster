...
public interface FinalidadeAmostraRepository extends JpaRepository<FinalidadeAmostra, Long> {
    ...
    @Query(
        value = "select distinct finalidadeAmostra from FinalidadeAmostra finalidadeAmostra left join fetch finalidadeAmostra.tipoFinalidadeAmostra",
    ...
    @Query(
        "select distinct finalidadeAmostra from FinalidadeAmostra finalidadeAmostra left join fetch finalidadeAmostra.tipoFinalidadeAmostra"
    )
    List<FinalidadeAmostra> findAllWithToOneRelationships();

    @Query(
        "select finalidadeAmostra from FinalidadeAmostra finalidadeAmostra left join fetch finalidadeAmostra.tipoFinalidadeAmostra where finalidadeAmostra.id =:id"
    )

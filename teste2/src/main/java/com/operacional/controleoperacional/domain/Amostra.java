...
public class Amostra extends AbstractAuditingEntity{
     ...
     */
    @Column(name = "descricao_de_origem")
    private String descricaoDeOrigem;
    ...
    public String getDescricaoDeOrigem() {
        return this.descricaoDeOrigem;
    }

    public Amostra descricaoDeOrigem(String descricaoDeOrigem) {
        this.setDescricaoDeOrigem(descricaoDeOrigem);
        return this;
    }

    public void setDescricaoDeOrigem(String descricaoDeOrigem) {
    ...
    public String toString() {
        return "Amostra{" +
            ...
            ", descricaoDeOrigem='" + getDescricaoDeOrigem() + "'" +

...
class AmostraResourceIT {
    ...
    private static final String DEFAULT_DESCRICAO_DE_ORIGEM = "AAAAAAAAAA";
    private static final String UPDATED_DESCRICAO_DE_ORIGEM = "BBBBBBBBBB";
    ...
    public static Amostra createEntity(EntityManager em) {
        Amostra amostra = new Amostra()
            ...
            .descricaoDeOrigem(DEFAULT_DESCRICAO_DE_ORIGEM)
    ...
    public static Amostra createUpdatedEntity(EntityManager em) {
        Amostra amostra = new Amostra()
            ...
            .descricaoDeOrigem(UPDATED_DESCRICAO_DE_ORIGEM)
    ...
    void createAmostra() throws Exception {
        ...
        assertThat(testAmostra.getDescricaoDeOrigem()).isEqualTo(DEFAULT_DESCRICAO_DE_ORIGEM);
    ...
    void getAllAmostras() throws Exception {
        ...
        restAmostraMockMvc
            ...
            .andExpect(jsonPath("$.[*].descricaoDeOrigem").value(hasItem(DEFAULT_DESCRICAO_DE_ORIGEM)))
    ...
    void getAmostra() throws Exception {
        ...
        restAmostraMockMvc
            ...
            .andExpect(jsonPath("$.descricaoDeOrigem").value(DEFAULT_DESCRICAO_DE_ORIGEM))
    ...
    @Test
    @Transactional
    void getAllAmostrasByDescricaoDeOrigemIsEqualToSomething() throws Exception {
        // Initialize the database
        amostraRepository.saveAndFlush(amostra);

        // Get all the amostraList where descricaoDeOrigem equals to DEFAULT_DESCRICAO_DE_ORIGEM
        defaultAmostraShouldBeFound("descricaoDeOrigem.equals=" + DEFAULT_DESCRICAO_DE_ORIGEM);

        // Get all the amostraList where descricaoDeOrigem equals to UPDATED_DESCRICAO_DE_ORIGEM
        defaultAmostraShouldNotBeFound("descricaoDeOrigem.equals=" + UPDATED_DESCRICAO_DE_ORIGEM);
    }

    @Test
    @Transactional
    void getAllAmostrasByDescricaoDeOrigemIsNotEqualToSomething() throws Exception {
        // Initialize the database
        amostraRepository.saveAndFlush(amostra);

        // Get all the amostraList where descricaoDeOrigem not equals to DEFAULT_DESCRICAO_DE_ORIGEM
        defaultAmostraShouldNotBeFound("descricaoDeOrigem.notEquals=" + DEFAULT_DESCRICAO_DE_ORIGEM);

        // Get all the amostraList where descricaoDeOrigem not equals to UPDATED_DESCRICAO_DE_ORIGEM
        defaultAmostraShouldBeFound("descricaoDeOrigem.notEquals=" + UPDATED_DESCRICAO_DE_ORIGEM);
    }

    @Test
    @Transactional
    void getAllAmostrasByDescricaoDeOrigemIsInShouldWork() throws Exception {
        // Initialize the database
        amostraRepository.saveAndFlush(amostra);

        // Get all the amostraList where descricaoDeOrigem in DEFAULT_DESCRICAO_DE_ORIGEM or UPDATED_DESCRICAO_DE_ORIGEM
        defaultAmostraShouldBeFound("descricaoDeOrigem.in=" + DEFAULT_DESCRICAO_DE_ORIGEM + "," + UPDATED_DESCRICAO_DE_ORIGEM);

        // Get all the amostraList where descricaoDeOrigem equals to UPDATED_DESCRICAO_DE_ORIGEM
        defaultAmostraShouldNotBeFound("descricaoDeOrigem.in=" + UPDATED_DESCRICAO_DE_ORIGEM);
    }

    @Test
    @Transactional
    void getAllAmostrasByDescricaoDeOrigemIsNullOrNotNull() throws Exception {
        // Initialize the database
        amostraRepository.saveAndFlush(amostra);

        // Get all the amostraList where descricaoDeOrigem is not null
        defaultAmostraShouldBeFound("descricaoDeOrigem.specified=true");

        // Get all the amostraList where descricaoDeOrigem is null
        defaultAmostraShouldNotBeFound("descricaoDeOrigem.specified=false");
    }

    @Test
    @Transactional
    void getAllAmostrasByDescricaoDeOrigemContainsSomething() throws Exception {
        // Initialize the database
        amostraRepository.saveAndFlush(amostra);

        // Get all the amostraList where descricaoDeOrigem contains DEFAULT_DESCRICAO_DE_ORIGEM
        defaultAmostraShouldBeFound("descricaoDeOrigem.contains=" + DEFAULT_DESCRICAO_DE_ORIGEM);

        // Get all the amostraList where descricaoDeOrigem contains UPDATED_DESCRICAO_DE_ORIGEM
        defaultAmostraShouldNotBeFound("descricaoDeOrigem.contains=" + UPDATED_DESCRICAO_DE_ORIGEM);
    }

    @Test
    @Transactional
    void getAllAmostrasByDescricaoDeOrigemNotContainsSomething() throws Exception {
        // Initialize the database
        amostraRepository.saveAndFlush(amostra);

        // Get all the amostraList where descricaoDeOrigem does not contain DEFAULT_DESCRICAO_DE_ORIGEM
        defaultAmostraShouldNotBeFound("descricaoDeOrigem.doesNotContain=" + DEFAULT_DESCRICAO_DE_ORIGEM);

        // Get all the amostraList where descricaoDeOrigem does not contain UPDATED_DESCRICAO_DE_ORIGEM
        defaultAmostraShouldBeFound("descricaoDeOrigem.doesNotContain=" + UPDATED_DESCRICAO_DE_ORIGEM);
    }
    ...
    void putNewAmostra() throws Exception {
        ...
        assertThat(testAmostra.getDescricaoDeOrigem()).isEqualTo(UPDATED_DESCRICAO_DE_ORIGEM);

...
describe('Problema e2e test', () => {
  ...
  const problemaSample = { dataVerificacao: '2022-04-28', descricao: 'B2B users', criticidade: 'IMEDIATA', impacto: 'Rodovia strategy' };
  ...
  describe('new Problema page', () => {
    ...
    it.skip('should create an instance of Problema', () => {
      ...
      cy.get(`[data-cy="dataFinalizacao"]`).type('2022-04-28').should('have.value', '2022-04-28');

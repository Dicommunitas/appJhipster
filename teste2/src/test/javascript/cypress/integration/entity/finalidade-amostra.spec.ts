...
describe('FinalidadeAmostra e2e test', () => {
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/amostras',
      body: {"dataHoraColeta":"2022-04-07T13:40:07.305Z","observacao":"copying","identificadorExterno":"Prático FTP","recebimentoNoLaboratorio":"2022-04-07T02:00:46.785Z","createdBy":"user-centric Marginal","createdDate":"2022-04-07T08:22:30.451Z","lastModifiedBy":"protocol Monitored","lastModifiedDate":"2022-04-07T05:16:16.311Z"},
    }).then(({ body }) => {
      amostra = body;
    });
  });

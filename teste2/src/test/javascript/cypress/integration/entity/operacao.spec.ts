...
describe('Operacao e2e test', () => {
  ...
  describe('new Operacao page', () => {
    ...
    it('should create an instance of Operacao', () => {
      ...
      cy.get(`[data-cy="inicio"]`).type('2022-04-07T07:04').should('have.value', '2022-04-07T07:04');

      cy.get(`[data-cy="fim"]`).type('2022-04-07T08:25').should('have.value', '2022-04-07T08:25');
      ...
      cy.get(`[data-cy="lastModifiedDate"]`).type('2022-04-07T16:48').should('have.value', '2022-04-07T16:48');

...
/**
 * REST controller for managing {@link com.operacional.controleamostramicroservice.domain.B}.
 */
@RestController
@RequestMapping("/api")
public class BResource {
    ...
    private static final String ENTITY_NAME = "controleAmostraMicroserviceB";
    ...
    public ResponseEntity<B> partialUpdateB(@PathVariable(value = "id", required = false) final Long id, @RequestBody B b)
        ...
        Optional<B> result = bService.partialUpdate(b);
    ...
    public ResponseEntity<B> getB(@PathVariable Long id) {
        ...
        Optional<B> b = bService.findOne(id);

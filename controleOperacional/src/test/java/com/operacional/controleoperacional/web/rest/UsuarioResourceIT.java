...
class UsuarioResourceIT {
    ...
    private static final String DEFAULT_CHAVE = "AAAA";
    private static final String UPDATED_CHAVE = "BBBB";
    ...
    public static Usuario createEntity(EntityManager em) {
        Usuario usuario = new Usuario().chave(DEFAULT_CHAVE).nome(DEFAULT_NOME).linksExternos(DEFAULT_LINKS_EXTERNOS);
        // Add required entity
    ...
    public static Usuario createUpdatedEntity(EntityManager em) {
        Usuario usuario = new Usuario().chave(UPDATED_CHAVE).nome(UPDATED_NOME).linksExternos(UPDATED_LINKS_EXTERNOS);
        // Add required entity
        User user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    void createUsuario() throws Exception {
        ...
        assertThat(testUsuario.getChave()).isEqualTo(DEFAULT_CHAVE);
        assertThat(testUsuario.getNome()).isEqualTo(DEFAULT_NOME);
        assertThat(testUsuario.getLinksExternos()).isEqualTo(DEFAULT_LINKS_EXTERNOS);
    }
    ...
    void putNewUsuario() throws Exception {
        ...
        updatedUsuario.chave(UPDATED_CHAVE).nome(UPDATED_NOME).linksExternos(UPDATED_LINKS_EXTERNOS);
        ...
        Usuario testUsuario = usuarioList.get(usuarioList.size() - 1);
        assertThat(testUsuario.getChave()).isEqualTo(UPDATED_CHAVE);
        assertThat(testUsuario.getNome()).isEqualTo(UPDATED_NOME);
        assertThat(testUsuario.getLinksExternos()).isEqualTo(UPDATED_LINKS_EXTERNOS);
    }
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.chave(UPDATED_CHAVE).nome(UPDATED_NOME);
    ...
    void fullUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.chave(UPDATED_CHAVE).nome(UPDATED_NOME).linksExternos(UPDATED_LINKS_EXTERNOS);
